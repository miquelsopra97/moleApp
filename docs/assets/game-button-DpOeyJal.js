...
`;var C=Object.getOwnPropertyDescriptor,P=(e,t,r,a)=>{for(var o=a>1?void 0:a?C(t,r):t,n=e.length-1,s;n>=0;n--)(s=e[n])&&(o=s(o)||o);return o};let c=class extends p{constructor(){super(...arguments),this.elementController=new v(this),this._scroller=null}firstUpdated(e){var t,r;super.firstUpdated(e),this._scroller=(t=this.shadowRoot)==null?void 0:t.querySelector(".scroller"),(r=this._scroller)==null||r.addEventListener("scroll",a=>{var o;this.elementController.publish("scroll",{scrollTop:(o=a.target)==null?void 0:o.scrollTop})})}disconnectedCallback(){var e;(e=this._scroller)==null||e.removeEventListener("scroll",t=>{var r;this.elementController.publish("scroll",{scrollTop:(r=t.target)==null?void 0:r.scrollTop})}),this.elementController.unsubscribe("scroll"),super.disconnectedCallback()}render(){return i`
      <div class="scroller">
        <div class="content">
          <div class="region">
            <div class="zone">
