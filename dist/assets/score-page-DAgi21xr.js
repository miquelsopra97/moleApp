          ...
          ${this._scores.length?o`
                <ul>
                  ${this._scores.map((e,s)=>o`
                      <li><strong>${s+1}. ${e.name}</strong> — ${e.score} pts</li>
                    `)}
                </ul>
              `:o`<p>No hay puntuaciones todavía.</p>`}
