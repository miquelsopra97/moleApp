import{E as G,_ as s,a as b,n as h,i as m,t as f,b as H,r as L,x as p,c as u}from"./index-lBCuaVSB.js";import{P as U}from"./PageTransitionsMixin-C3JExxZE.js";/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const q=["focusin","focusout","pointerdown"];class S extends b{constructor(){super(...arguments),this.visible=!1,this.inward=!1,this.attachableController=new B(this,this.onControlChange.bind(this))}get htmlFor(){return this.attachableController.htmlFor}set htmlFor(t){this.attachableController.htmlFor=t}get control(){return this.attachableController.control}set control(t){this.attachableController.control=t}attach(t){this.attachableController.attach(t)}detach(){this.attachableController.detach()}connectedCallback(){super.connectedCallback(),this.setAttribute("aria-hidden","true")}handleEvent(t){var e;if(!t[R]){switch(t.type){default:return;case"focusin":this.visible=((e=this.control)==null?void 0:e.matches(":focus-visible"))??!1;break;case"focusout":case"pointerdown":this.visible=!1;break}t[R]=!0}}onControlChange(t,e){for(const i of q)t==null||t.removeEventListener(i,this),e==null||e.addEventListener(i,this)}update(t){t.has("visible")&&this.dispatchEvent(new Event("visibility-changed")),super.update(t)}}s([h({type:Boolean,reflect:!0})],S.prototype,"visible",void 0);s([h({type:Boolean,reflect:!0})],S.prototype,"inward",void 0);const R=Symbol("handledByFocusRing");/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const j={ATTRIBUTE:1},W=r=>(...t)=>({_$litDirective$:r,values:t});class K{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */function ct(r){r.addInitializer(t=>{const e=t;e.addEventListener("click",async i=>{const{type:a,[T]:o}=e,{form:n}=o;if(!(!n||a==="button")&&(await new Promise(c=>{setTimeout(c)}),!i.defaultPrevented)){if(a==="reset"){n.reset();return}n.addEventListener("submit",c=>{Object.defineProperty(c,"submitter",{configurable:!0,enumerable:!0,get:()=>e})},{capture:!0,once:!0}),o.setFormValue(e.value),n.requestSubmit()}})})}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: Apache-2.0
 */const mt=dt(b);class d extends mt{get name(){return this.getAttribute("name")??""}set name(t){this.setAttribute("name",t)}get form(){return this[T].form}constructor(){super(),this.disabled=!1,this.href="",this.target="",this.trailingIcon=!1,this.hasIcon=!1,this.type="submit",this.value="",this.handleActivationClick=t=>{!ut(t)||!this.buttonElement||(this.focus(),ht(this.buttonElement))},this.addEventListener("click",this.handleActivationClick)}focus(){var t;(t=this.buttonElement)==null||t.focus()}blur(){var t;(t=this.buttonElement)==null||t.blur()}render(){var a;const t=this.disabled&&!this.href,e=this.href?this.renderLink():this.renderButton(),i=this.href?"link":"button";return p`
      ...
      ${e}
    `}renderButton(){const{ariaLabel:t,ariaHasPopup:e,ariaExpanded:i}=this;return p`<button
      id="button"
      class="button"
      ...
      aria-expanded="${i||u}">
      ${this.renderContent()}
    </button>`}renderLink(){const{ariaLabel:t,ariaHasPopup:e,ariaExpanded:i}=this;return p`<a
      id="link"
      class="button"
      aria-label="${t||u}"
      aria-haspopup="${e||u}"
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let k=class extends yt{};k.styles=[_t];k=s([f("md-icon")],k);var xt=Object.getOwnPropertyDescriptor,Ct=(r,t,e,i)=>{for(var a=i>1?void 0:i?xt(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(a=n(a)||a);return a};let $=class extends U(b){constructor(){super(...arguments),this.pageController=new _(this),this._layout=null}firstUpdated(r){var t;(t=super.firstUpdated)==null||t.call(this,r),this._layout=this.querySelector("page-layout")}createRenderRoot(){return this}render(){return p`
      <page-layout>
        <div>
          <ul>
            <li>
